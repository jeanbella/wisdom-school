...
const samplePosts = [
  ...
  },
  {
    ...
    excerpt: "Download the full academic calendar for the upcoming school year — term dates, holidays, and key events.",
    author: "Admin Office",
    date: "2025-09-10",
    category: "Our Calendar",
    image: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=800&q=60",
    pdf: "/school-calendar-2025-2026.pdf", // add this field
  }  
];

const categories = ["All", "Announcements", "Events", "Academic", "Community","Our Calender"];

export default function KigaliBlogPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-semibold">WISDOM SCHOOL KIGALI BRANCH</h1>
        ...
        {activePage === "contact" && (
          <section className="max-w-3xl mx-auto bg-white rounded-2xl p-8 shadow-sm">
            ...
            <div className="space-y-3 text-gray-700">
              <p className="flex items-center gap-2"><Mail className="w-5 h-5 text-indigo-600" /> info@wisdomschoolkigali.edu</p>
              <p className="flex items-center gap-2"><Phone className="w-5 h-5 text-indigo-600" /> +250 788 123 456</p>
              <p className="flex items-center gap-2"><MapPin className="w-5 h-5 text-indigo-600" /> 123 School Road, Kigali, Rwanda</p>
            </div>
